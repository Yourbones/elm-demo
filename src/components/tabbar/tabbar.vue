<template>
  <section id="tabbar">
    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
      ...
      <defs>
        <symbol viewBox="0 0 40 40" id="takeaway">
        ...
        <symbol xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 40 40" id="takeawayActive">
          <defs>
        ...
        <symbol xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 40 40" id="search">
          <defs>
        ...
        <symbol xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 40 40" id="searchActive">
          <defs>
            <path id="discover-regular.8ef537f_a"
                  d="M20 40c11.046 0 20-8.954 20-20S31.046 0 20 0 0 8.954 0 20s8.954 20 20 20z"></path>
            <mask id="discover-regular.8ef537f_b" width="40" height="40" x="0" y="0" fill="#fff">
...
<script>
  ...
  export default {
    ...
    methods: {
      gotoAddress (path) {
        this.$router.push(path) // 在 history 栈中添加一条记录
      }
    }
  }
</script>
